...
public:
    ...
    std::vector<GlobalCartesianCoordinate> CalculateTrajectory(const int count_previous, const VehicleState& target_state, const Time timestep, const Time time_horizon) const;
};
