...
public:
    ...
    std::vector<GlobalCartesianCoordinate> calculate_trajectory(const int count_previous, const VehicleState& target_state, const Speed max_speed, const Time timestep, const Time time_horizon) const;
};
